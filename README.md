...
This library is an open source client that allows you to connect to the [Pusher webservice](http://pusherapp.com/). It keeps largely the same API as the [pusher-js library](http://github.com/pusher/pusher-js/), with a few differences.
